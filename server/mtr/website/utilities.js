...
const UTILITIES = {
	...
	angles: [0, 45, 90, 135],
	fonts: ["Inter", "MiSans Latin", "Helvetica Neue", "Helvetica", "Roboto", "BlinkMacSystemFont", "MiSans", "HarmonyOS Sans SC", "PingFang SC", "Hiragino Sans GB", "Microsoft YaHei", "微软雅黑", "Noto Serif SC", "Noto Serif TC", "Material Icons"],
	obaMode: false,
	testMode: false,
};
